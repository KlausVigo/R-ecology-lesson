...
author: Klaus Schliep, François Michonneau & Auriel Fournier
---


This is based on the Data Carpentry lesson _Data Analysis and Visualization in R for Ecologists_
from François Michonneau & Auriel Fournier (Lesson Maintainers). 
...
6. [Producing reports with **`knitr`**](05-Reports_with_knitr.html)
7. [Control flow](06-control-flow.html)
8. [Vectorization](08-vectorization.html)
9. [Functions](07-functions.html)
10. [Command line](09-commandline.html)
11. [Writing good software](16-wrap-up.html)
